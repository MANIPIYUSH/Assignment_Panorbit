...
const ProfileHomePage = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      setUser(res.data.users.find(user => user.id === parseInt(userId)));
    };
    fetchUser();
  }, [userId]);
            ...
            <div className='py-12 px-8 w-[76%]'>
              ...
              <div className=' flex flex-warp justify-between mt-4 p-8'>
                <div className='p-4 w-[35%]'>
                  <div>
                    <img
                      className='w-52 h-52 rounded-full m-auto '
                  ...
                  <div className='leading-8  '>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      Username : <b className='text-gray-700 text-left'>{dataArr?.username}</b>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      e-mail : <b className='text-gray-700 text-left'>{dataArr?.email}</b>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      Phone : <b className='text-gray-700 text-left'>{dataArr?.phone}</b>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      Website : <b className='text-gray-700 text-left'>{dataArr?.website}</b>
                    </p>
                  </div>
                  <hr />
                  <div className='leading-10 '>
                    ...
                    <p className='text-gray-500 font-medium flex justify-between w-[89%]'>
                      Name : <b className='text-gray-700'>{dataArr?.company.name}</b>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      catchphrase : <p className='w-[60%]'><b className='text-gray-700'>{dataArr?.company.catchPhrase}</b></p>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      bs : <p className='w-[60%]'><b className='text-gray-700'>{dataArr?.company.bs}</b></p>
                    </p>
                  </div>
                </div>
                ...
                <div className=' w-[50%] p-4 '>
                  <div className='leading-8 w-[65%] '>
                    ...
                    <p className='text-gray-500 font-medium flex justify-between'>
                      Street : <b className='text-gray-700'>{dataArr?.address.street}</b>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      Suite : <b className='text-gray-700'>{dataArr?.address.suite}</b>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      City : <b className='text-gray-700'>{dataArr?.address.city}</b>
                    </p>
                    <p className='text-gray-500 font-medium flex justify-between'>
                      Zipcode : <b className='text-gray-700'>{dataArr?.address.zipcode}</b>
                    </p>
                  </div>
                  <hr />
                  <div className='pt-4'>
                    ...
                    <div className='flex justify-end gap-4'>
                      <p className='text-gray-500 font-medium flex'>
                        Lat: <p className='text-gray-700'>{dataArr?.address.geo.lat}</p>
                      </p>
                      <p className='text-gray-500 font-medium flex'>
                        Lng: <p className='text-gray-700'>{dataArr?.address.geo.lng}</p>
                      </p>
                    </div>
                  </div>
                </div>
